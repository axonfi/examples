...
```bash
python lend.py supply              # supply 100 USDC (default)
python lend.py withdraw            # withdraw 100 USDC
python lend.py balance             # check USDC + aUSDC balances
SUPPLY_AMOUNT=500 python lend.py supply    # custom amount
```
