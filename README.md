...
| [express-402-server](typescript/express-402-server/)   | ![TypeScript](https://img.shields.io/badge/-TypeScript-3178C6?logo=typescript&logoColor=white) | **A paywall for APIs.** Your server returns HTTP 402 ("Payment Required"). The bot pays, gets the content. Like putting a $0.01 toll on every API call. _(Coming soon)_                                                             |
